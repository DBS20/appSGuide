...
class GlobalColors {
  ...
  static const Color colorDarkGrey = const Color(0xff1E1E27);
  static const Color colorGrey = const Color(0xff2F2F3B);
  static const Color colorLightGrey = const Color(0xff515160);
  static const Color colorBlack = const Color(0xff000000);
  static const Color colorBlueRaf = const Color(0xff6985C0);
  static const Color colorBlue = const Color(0xff0D7CCE);
